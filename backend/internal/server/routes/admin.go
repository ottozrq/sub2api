...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.GET("/dispositions", h.Admin.User.ListDispositions)
		...
		users.POST("/:id/disposition", h.Admin.User.ApplyDisposition)
		users.POST("/:id/unban", h.Admin.User.UnbanDispositionUser)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.POST("/:id/adjust-total-quota", h.Admin.Subscription.AdjustTotalQuota)
