...
func (s *BillingService) initFallbackPricing() {
	...
	s.fallbackPrices["gpt-5.6-sol"] = newGPT56ModelPricing(5e-6, 10e-6, 30e-6, 60e-6, 0.5e-6, 1e-6)
	s.fallbackPrices["gpt-5.6-terra"] = newGPT56ModelPricing(2.5e-6, 5e-6, 15e-6, 30e-6, 0.25e-6, 0.5e-6)
	s.fallbackPrices["gpt-5.6-luna"] = newGPT56ModelPricing(1e-6, 2e-6, 6e-6, 12e-6, 0.1e-6, 0.2e-6)
...
func newGPT56ModelPricing(input, inputPriority, output, outputPriority, cacheRead, cacheReadPriority float64) *ModelPricing {
	return &ModelPricing{
		...
		CacheCreationPricePerToken:         input * 1.25,
		CacheCreationPricePerTokenPriority: inputPriority * 1.25,
