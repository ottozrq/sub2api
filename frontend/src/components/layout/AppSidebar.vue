<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-lg border border-dark-100 bg-white shadow-sm dark:border-dark-700 dark:bg-dark-900">
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/user-dispositions', label: t('nav.userDispositions'), icon: ShieldIcon, hideInSimpleMode: true },
